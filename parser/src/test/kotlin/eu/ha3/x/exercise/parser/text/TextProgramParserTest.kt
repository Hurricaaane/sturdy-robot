 ...
 * @author Ha3
 */
public class TextProgramParserTest {
    @Test
    public fun `it should not try to deserialize zero lines`() {
        // Exercise and Verify
        assertThrows(TextProgramParser.TextProgramParseException::class.java) {
            TextProgramParser().deserialize(emptyList())
        }
    }
    ...
    public fun `it should not try to deserialize the first line given an invalid input`() {
        ...
        assertAll(
            Executable {
                assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                    TextProgramParser().deserialize(listOf(""))
                }
            },
            Executable {
                assertThrows(TextProgramParser.TextProgramParseException::class.java) {
            ...
            Executable {
                assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                    TextProgramParser().deserialize(listOf("1"))
                }
            },
            Executable {
                assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                    TextProgramParser().deserialize(listOf("1 1 1"))
                }
            },
            Executable {
                assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                    TextProgramParser().deserialize(listOf("x 1"))
                }
            },
            Executable {
                assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                    TextProgramParser().deserialize(listOf("x x"))
                }
            }
        )
    }
    ...
    public fun `it should deserialize the surface only`() {
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10"))

        // Verify
        assertThat(result).isEqualTo(Program(Surface(6, 11), emptyList()))
    }
    ...
    public fun `it should not try to deserialize the second line given an invalid input`() {
        ...
        assertAll(
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 10", "G"))
                    }
                },
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "x 10 N", "G"))
                    }
                },
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 x N", "G"))
                    }
                },
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 10 Z", "G"))
                    }
                },
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 10 20", "G"))
                    }
                },
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 10 N 20", "G"))
                    }
                }
        )
    }
    ...
    public fun `it should deserialize the second line with north`() {
        ...
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10", "5 10 N", ""))

        // Verify
        assertThat(result).isEqualTo(Program(Surface(6, 11), expected))
    }
    ...
    public fun `it should deserialize the second line with east`() {
        ...
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10", "5 10 E", ""))
    ...
    public fun `it should deserialize the second line with south`() {
        ...
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10", "5 10 S", ""))
    ...
    public fun `it should deserialize the second line with west`() {
        ...
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10", "5 10 W", ""))
    ...
    public fun `it should not try to deserialize the third line given an invalid input`() {
        ...
        assertAll(
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 10 N", "B"))
                    }
                },
                Executable {
                    assertThrows(TextProgramParser.TextProgramParseException::class.java) {
                        TextProgramParser().deserialize(listOf("5 10", "5 10 N", "G G"))
                    }
                }
        )
    }
    ...
    public fun `it should deserialize the third line`() {
        ...
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10", "5 10 N", "GGDDAAGDA"))
    ...
    public fun `it should deserialize the fourth and more lines`() {
        ...
        // Exercise
        val result = TextProgramParser().deserialize(listOf("5 10", "5 10 N", "G", "1 2 W", "DA"))

        // Verify
        assertThat(result).isEqualTo(Program(Surface(6, 11), listOf(expectedA, expectedB)))
    }
    ...
    public fun `it should not deserialize an even number of lines`() {
        // Exercise and Verify
        assertThrows(TextProgramParser.TextProgramParseException::class.java) {
            TextProgramParser().deserialize(listOf("5 10", "5 10 N", "G", "1 2 W"))
        }
    }
}